...
def create_demo_map():
    ...
    def custom_save():
        ...
        print("✅ Demo map saved as: demo_map.json")
...
def main():
    ...
    parser.add_argument(
        "--editor", action="store_true", help="Launch interactive map editor"
    )
    parser.add_argument(
        "--edit", metavar="MAP", help="Launch editor with specific map loaded"
    )
