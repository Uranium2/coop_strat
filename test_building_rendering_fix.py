...
def test_building_rendering_coordinates():
    ...
    old_visible = (-TILE_SIZE < old_screen_x < screen_width and -TILE_SIZE < old_screen_y < screen_height)
    new_visible = (-TILE_SIZE < new_screen_x < screen_width and -TILE_SIZE < new_screen_y < screen_height)
    ...
    print(f"   With camera at origin, building should render at ({new_screen_x}, {new_screen_y})")
