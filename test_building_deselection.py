...
async def test_building_deselection():
    ...
    assert game_scene.building_menu.selected_building_type is None, "No building should be selected initially"
    ...
    assert game_scene.building_menu.selected_building_type == BuildingType.WALL, "WALL should be selected"
    ...
    print(f"   Before clear: selected_building_type = {game_scene.building_menu.selected_building_type}")
    ...
    assert game_scene.building_menu.selected_building_type is None, "Building should be deselected after clear_selection()"
    ...
    assert game_scene.building_menu.selected_building_type == BuildingType.TOWER, "TOWER should be selected"
    ...
    assert game_scene.building_menu.selected_building_type is None, "Building should be deselected again"
    assert not game_scene.building_placer.is_placing(), "Building placer should be inactive"
