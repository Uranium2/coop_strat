...
import pygame
from shared.models.game_models import Hero, Position, HeroType, Resources
...
def test_building_menu_auto_open():
    ...
    assert not game_scene.building_menu.visible, "Building menu should be initially hidden"
    ...
    assert game_scene.building_menu.visible, "Building menu should be visible after selecting hero"
    ...
    assert not game_scene.building_menu.visible, "Building menu should be hidden when selecting non-hero"
    ...
    assert game_scene.building_menu.visible, "Building menu should be visible after selecting hero again"
    
    game_scene._handle_left_click((100, 100))  # Click on empty space
    assert not game_scene.building_menu.visible, "Building menu should be hidden when clicking empty space"
